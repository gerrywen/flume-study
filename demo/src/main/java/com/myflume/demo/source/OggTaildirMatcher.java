...
public class OggTaildirMatcher {
  private static final Logger logger = LoggerFactory.getLogger(OggTaildirMatcher.class);
   ...
   * @see TaildirSourceConfigurationConstants
   */
  OggTaildirMatcher(String fileGroup, String filePattern, boolean cachePatternMatching) {
  ...
  public boolean equals(Object o) {
    ...
    OggTaildirMatcher that = (OggTaildirMatcher) o;
